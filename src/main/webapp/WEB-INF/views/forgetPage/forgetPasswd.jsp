...
<body>
	...
	<form class="layui-form" action="changePasswd.do?userType=<%=request.getParameter("userType") %>" method="post" id="myform">
		<div class="demo-reg-container">
					...
					<div class="layui-col-xs5">
						<div style="margin-left: 11px;">
							<button type="button"
								...
								onclick="save(); send('<%=request.getParameter("userType") %>');">获取验证码</button>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="layui-form-item">
				<button class="layui-btn layui-btn-fluid" lay-submit onclick="save()">提交</button>
			</div>
